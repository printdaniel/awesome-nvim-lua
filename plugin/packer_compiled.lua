...
_G.packer_plugins = {
  ...
  hop = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/hop",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua",
  ...
  ["nvim-toggleterm.lua"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/nvim-toggleterm.lua",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  ["toggle-lsp-diagnostics.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/toggle-lsp-diagnostics.nvim",
